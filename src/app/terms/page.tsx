    ...
    <div className="min-h-screen pt-32 pb-20 px-4 bg-black text-white">
      <div className="max-w-3xl mx-auto animate-fade-in-up">
        ...
        <div className="prose prose-invert max-w-none text-gray-300 space-y-6 bg-white/5 border border-white/10 p-8 rounded-2xl">
          ...
          <p><strong>제2조 (회원의 정의)</strong><br />"회원"이란 사이트에 접속하여 본 약관에 따라 소정의 회원가입 절차를 완료하고, 사이트가 제공하는 프리미엄 지식 창고 및 관련 정기 정보(마케팅 및 혜택 알림 포함)를 수신 및 이용하는 자를 말합니다.</p>
          <p><strong>제3조 (서비스의 제공)</strong><br />사이트는 회원에게 다음과 같은 서비스를 우선적으로 제공합니다.<br />1. 독점 지식 창고 메뉴 열람 권한<br />2. 서적 및 교재 증정 이벤트 참여 기회 부여<br />3. 오프라인/온라인 특강 시 우선 초대 및 수강 혜택 제공<br />4. 특별한 마케팅 인사이트 뉴스레터 발송</p>
