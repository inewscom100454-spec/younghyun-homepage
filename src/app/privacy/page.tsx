export default function PrivacyPage() {
  return (
    <div className="min-h-[80vh] pt-48 pb-20 bg-black text-white flex flex-col justify-center items-center px-4">
      <div className="mb-10 text-center w-full max-w-3xl animate-fade-in-up">
        <h1 className="text-3xl font-bold mb-4">개인정보 처리방침</h1>
        <hr className="border-white/20 mb-6" />
      </div>
      
      <div className="w-full max-w-3xl animate-fade-in-up text-left">
        <div className="prose prose-invert max-w-none text-gray-300 space-y-6 bg-white/5 border border-white/10 p-8 rounded-2xl leading-relaxed text-[15px] break-keep">
          ...
          <p className="text-sm text-gray-500 text-center">※ 본 처리방침은 사이트 최초 구축에 따른 기본 표준 안내문이며, 나중에 사이트 운영 및 관리를 위한 상세 위탁/처리 방침이 추가되면 고지될 수 있습니다.</p>
        </div>
      </div>
    </div>
  );
